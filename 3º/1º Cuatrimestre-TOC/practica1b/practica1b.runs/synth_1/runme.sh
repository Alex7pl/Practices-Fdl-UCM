...
HD_PWD='C:/Users/alexs/source/repos/practica1b/practica1b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_reg.tcl
