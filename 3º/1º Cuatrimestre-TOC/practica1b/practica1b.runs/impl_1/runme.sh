...
HD_PWD='C:/Users/alexs/source/repos/practica1b/practica1b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_reg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parallel_reg.tcl -notrace
